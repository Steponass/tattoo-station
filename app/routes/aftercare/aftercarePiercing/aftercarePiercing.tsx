...
export const meta: Route.MetaFunction = ({ params }) => {
  const content = getIntlayer("aftercarePiercing", params.locale);
...
export default function aftercarePiercing() {
  const { heading1, heading2, 
    aftercare1, aftercare2, aftercare3, aftercare4, aftercare5, 
    aftercareA, aftercareB, aftercareC, aftercareD, aftercareE } = useIntlayer("aftercarePiercing");
  ...
  return (
    <main id={styles.piercing_aftercare_main}>
      ...
      <ol className={styles.aftercare_list}>
        <li>
          <svg id={styles.cotton_swab}
          xmlns="http://www.w3.org/2000/svg" width="3.5em" height="3.5em" viewBox="0 0 24 24"><title xmlns="">medical-cotton-swab</title><path fill="currentColor" d="M3 3h12v2H3zM2 21h14V6H2zm3-9h2.5V9.5h3V12H13v3h-2.5v2.5h-3V15H5zm15-6c-1.7 0-3 1.8-3 4c0 1.8.8 3.2 2 3.8V21h2v-7.2c1.2-.5 2-2 2-3.8c0-2.2-1.3-4-3-4"/>
          </svg>
          {aftercare1}</li>
        <li>{aftercare2}</li>
        <li>{aftercare3}
          <svg id={styles.no_swimming_icon} 
          viewBox="0 0 60.601004 60.601004" fill="var(--color-accent)">
            <path d="m 20.925501,30.834878 c 0,-2.03875 -1.65,-3.68875 -3.6875,-3.68875 -2.0375,0 -3.6875,1.65 -3.6875,3.68875 0,2.035 1.65,3.6875 3.6875,3.6875 2.0375,0 3.6875,-1.6525 3.6875,-3.6875" style={{ fill: '#ffffff', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }}></path>
            <path d="m 32.425502,28.647378 c 2.6875,-2.7775 7.1125,-2.85625 9.8875,-0.17375 0.2375,0.22375 0.45,0.4625 0.6375,0.70875 l 3.2125,-1.9275 c -0.3875,-0.5025 -0.8125,-0.9825 -1.2875,-1.4375 -5.0875,-4.91875 -13.2125,-4.77625 -18.125,0.3175 -0.75,0.76875 -1.375,1.6075 -1.8875,2.49625 l -3.65,6.33375 -3.0875,2.5625 c 0.6375,0.3175 1.3625,0.495 2.125,0.495 1.3,0 2.4875,-0.5225 3.3625,-1.37375 l 0.5625,0 c 0.875,0.85125 2.0625,1.37375 3.3625,1.37375 1.3125,0 2.5,-0.5225 3.3625,-1.37375 l 0.575,0 c 0.8625,0.85125 2.05,1.37375 3.3625,1.37375 1.3125,0 2.5,-0.5225 3.3625,-1.37375 l 0.575,0 c 0.8625,0.85125 2.05,1.37375 3.3625,1.37375 0.9875,0 1.9,-0.29625 2.6625,-0.805 l -13.1625,-7.5975 c 0.225,-0.34 0.4875,-0.6675 0.7875,-0.9725" style={{ fill: '#ffffff', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }}></path>
            <path d="m 47.238003,44.138628 -30.775,-30.77125 c 3.775,-3.10625 8.6125,-4.9725003 13.8875,-4.9725003 12.0625,0 21.85,9.7900003 21.85,21.8625003 0,5.27125 -1.8625,10.1075 -4.9625,13.88125 z m -16.8875,7.98375 c -12.0875,0 -21.8750003,-9.79 -21.8750003,-21.865 0,-5.22625 1.8375003,-10.02625 4.9000003,-13.7875 l 30.7625,30.75 c -3.775,3.0625 -8.5625,4.9025 -13.7875,4.9025 z m -0.05,-49.1512503 c -15.0875,0 -27.3250003,12.2362503 -27.3250003,27.3312503 0,15.09125 12.2375003,27.3275 27.3250003,27.3275 15.0875,0 27.325,-12.23625 27.325,-27.3275 0,-15.095 -12.2375,-27.3312503 -27.325,-27.3312503" style={{ fill: 'var(--color-accent-1)', fillOpacity: 1, fillRule: 'nonzero', stroke: 'none' }}></path>
          </svg>
        </li>
        <li>{aftercare4}</li>
        <li>{aftercare5}</li>
      ...
      <ol className={styles.aftercare_list}>
        ...
        <li>
          <svg id={styles.toothbrush}
          xmlns="http://www.w3.org/2000/svg" width="3.5em" height="3.5em" viewBox="0 0 15 15"><title xmlns="">toothbrush</title><path fill="currentColor" d="M1.8 14.55L14.26 5.1c1.02-.78.99-.82-.11-2.42L.8 12.85l-.4.34l-.19.17c-.29.28-.27.41-.02.78l.32.46c.39.55.51.54 1.29-.05M12.29 0l1.44 2.09l-.62.47L11.67.47zm-1.03.78l1.45 2.09l-.62.47l-1.45-2.09zm-1.02.78l1.45 2.09l-.63.48l-1.45-2.09zm-1.02.78l1.45 2.08l-.64.48l-1.44-2.08zm-1.03.78l1.44 2.09l-.62.47L7.57 3.6z"/>
          </svg>
          {aftercareD}
